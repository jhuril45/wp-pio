<?php
  wp_register_script('load-reports-script', get_template_directory_uri() . '/assets/js/load_reports.js',array ( 'jquery' ), 1.1, true);
  wp_enqueue_script( 'load-reports-script');
?>
<q-card>
